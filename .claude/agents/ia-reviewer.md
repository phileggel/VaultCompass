...
## Skill File Rules (.claude/skills/**/*.md)
...
3. **Workflow step ↔ agent existence**: agents referenced in CLAUDE.md workflow steps (step 7, 7b, 8, 10, etc.) must exist → 🔴 if missing
