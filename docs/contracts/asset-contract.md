...
| `update_category` | `id: String, label: String` | `AssetCategory`      | `CategoryNotFound { id }`, `LabelEmpty`, `DuplicateName`, `SystemReadonly`, `DatabaseError` |
