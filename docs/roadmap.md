...
| Delete transaction            | ✅ Done (BE) | Backend done; confirmation UI not yet built (todo TRX-035)         |
| Delete confirmation dialog    | 🔲 Planned  | Frontend guard before deletion (TRX-035)                           |
| Transaction list view         | 🔲 Planned  | Display all transactions per account or per asset                  |
...
1. **Delete confirmation UI** — small, unblocks TRX-035; no new spec needed
2. **Transaction list view** — needed before sell; allows reviewing history
3. **Sell transaction** — unlocks phases 5 & 6; requires new spec
