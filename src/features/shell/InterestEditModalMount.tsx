...
/**
 * Shell-level URL-driven mount for editing an interest credit (INT-040).
 *
 * Subscribes to URL search params
 * (`modal=edit-interest&editTxId=…&editTxAccountId=…&editTxAssetId=…`) and
 * overlays the dedicated interest modal in edit mode (date/quantity/note
 ...
 */
export function InterestEditModalMount() {
  ...
  const active = modal === "edit-interest" && !!editTxId && !!accountId && !!assetId;
