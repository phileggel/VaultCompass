 ...
 * eight 32px buttons in four grid columns, their gaps and the cell padding — so Asset
...
export const PINNED_ACTIONS_HEADER =
  "sticky left-0 z-30 w-[188px] min-w-[188px] max-w-[188px] hover:bg-m3-surface-container-low";
export const PINNED_ASSET_HEADER = `sticky left-[188px] z-30 hover:bg-m3-surface-container-low ${PINNED_EDGE}`;
export const PINNED_ACTIONS_CELL = `sticky left-0 z-10 w-[188px] min-w-[188px] max-w-[188px] ${PINNED_ROW_BACKGROUND}`;
export const PINNED_ASSET_CELL = `sticky left-[188px] z-10 ${PINNED_ROW_BACKGROUND} ${PINNED_EDGE}`;
