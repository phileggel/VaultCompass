...
- a detached sync drive no longer reports the portfolio as reset

## [0.41.0] - 2026-09-12

### Added

- show the price refresh report in its own dialog

## [0.40.0] - 2026-09-11

### Added

- see what a price refresh did to each account's value

## [0.39.0] - 2026-08-28

### Added

- add a Browse button when changing the sync folder
...
- share your portfolio between computers through a synced folder

## [0.37.2] - 2026-07-29

### Fixed

- prices update again for funds with no recent trading days

## [0.37.1] - 2026-07-27

### Fixed

- downloading the exchange-rate history now works from the app
...
- let the account-details header wrap on narrow widths
  Nowrap stats + 8 action buttons overflowed at CI font metrics, overlapping
  the buttons (WebDriver click intercepted in 3 specs).
